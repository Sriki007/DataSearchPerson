...
{
	public void createPerson(Person person, PersonRepository personRepository) throws PersonInfomationIsNull, ImproperPersonInformation, InvalidPersonIDInformation, DuplicatePersonIDInformation, DuplicatePersonMobileInformation 
	{
		if(person == null)
		{
